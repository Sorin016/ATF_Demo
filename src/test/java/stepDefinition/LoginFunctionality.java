...
public class LoginFunctionality {
    ...
    LoginPage logins;
    waitUntilTime time;
    browserWindowPropreties browserWindowPropretiess;
    linkOfThewebsite linkOfThewebsite;
...
//       browserWindowPropretiess.maximizeWindow();
    ...
    public void login_button_is_displayed() {
      browserWindowPropretiess.closeBrowser();
      browserWindowPropretiess.quitBrowser();
    }
}