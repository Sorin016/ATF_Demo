...
public class RestAPIStepsStepDef extends AbstractStepDef{
    public final static String BASEURI=PropretyLoader.loadProperty("homePageUrlForAPI");
    ...
    public void selectCheckTheTransactionByAccountAndDate(String date,String acount) {
        RequestSpecification requestSpecification = RestAssured.given();
        requestSpecification.baseUri(BASEURI);
