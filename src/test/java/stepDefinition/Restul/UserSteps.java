...
public class UserSteps extends AbstractStepDef {
    ...
    @When("User inserts the few fields")
    ...
    @When("Not all mandatory fields are inserted error appears")
    ...
    @When("User inserts the rest of the mandatory fields")
